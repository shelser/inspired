      ...
      <Container>
        <div className={s.container}>
              ...
              {genderList?.map(item => (
                <li className={s.categoryItem} key={item}>
                  <h3 className={s.categorySubtitle}>
                    <NavLink to={`/catalog/${item}`} className={s.link}>{categories[item].title}</NavLink>
                  </h3>
                  <ul className={s.categorySublist}>
                    {categories[item]?.list?.map(category => (
                      <li className={s.categoryItem} key={category.slug}>
                        <NavLink 
                          to={`/catalog/${item}/${category.slug}`} 
                          className={s.link}>
                          {category.title}
                        </NavLink>
                      </li>
          ...
          <div className={s.contacts}>
            <a href="mailto:Inspired@gmail.com" className={s.link}>
              Inspired@gmail.com
            </a>
            <a href="tel:89304902620" className={s.link}>
              8 930 490 26 20
            </a>
          </div>
          <div className={s.copyright}>
            <span>&copy; INSPIRED, 2023</span>
          </div>
          <div className={s.development}>
            <ul className={s.developmentList}>
              ...
              <li className={s.developmentItem}>
                Developer: 
                <a href="#" className={s.link}>shelser</a>
              </li>
            </ul>
          </div>
        </div>
